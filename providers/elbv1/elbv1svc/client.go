...
// NewService initializes and returns a new ELBClassicService instance for the specified region
// and VPC using either the specified static credentials or the Instance IAM role.
